...
from ..dto.ManageInvoiceResponse import ManageInvoiceResponse
...
def deserialize_manage_invoice_response(element: ET.Element) -> Optional[ManageInvoiceResponse]:
    if element is None:
        return None

    result = ManageInvoiceResponse(
